...
git.branch(function(err: any, remoteBranchSummary: BranchSummary) {
    if (typeof(err) != "undefined" && err !== null)
        console.log(err);
    else if (validateRemoteBranch(remoteBranchSummary))
        git.branchLocal(function(err: any, localBranchSummary: BranchSummary) {
            if (typeof(err) != "undefined" && err !== null)
                console.log(err);
            else
