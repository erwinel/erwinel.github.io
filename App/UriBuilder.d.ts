export declare class UriBuilder implements URL {
...
export declare class UrlQuery implements URLSearchParams {
    private _properties;
...
export declare class PathNameCollection implements Iterable<string> {
...
declare class KnownSchemeDefinition {
    private _name;
    private _separator;
...
export declare class UriBuilderOld implements URL {
    private _properties;
    private _segments;
